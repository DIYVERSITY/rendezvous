# NOTE: This folder is managed by the main repository. Do not add .git, .gitignore, or .github folders/files here. All git configuration and CI/CD should be handled at the root level to avoid conflicts and ensure smooth syncing with the backend.
# Disclaimer: outdated
